...
export default function SignInPage() {
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-center overflow-hidden bg-background">
      ...
      <div className="absolute top-1/4 -left-20 w-125 h-125 bg-primary/30 rounded-full blur-[120px] animate-blob" />
      <div className="absolute bottom-1/4 -right-20 w-125 h-125 bg-accent/30 rounded-full blur-[120px] animate-blob animation-delay-2000" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-150 bg-chart-1/10 rounded-full blur-[140px] animate-blob animation-delay-4000" />
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="mb-10 flex flex-col items-center text-center">
          ...
          >
            <Database className="h-8 w-8 text-primary transition-transform group-hover:rotate-12" />
          </Link>
