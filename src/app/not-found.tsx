        ...
        <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-background px-6">
            ...
            <div className="relative z-10 flex flex-col items-center text-center max-w-lg">
                ...
                <p className="mb-10 text-lg text-muted-foreground leading-relaxed">
                    The record you're looking for seems to have been dropped from our database. 
                    Let's get you back to the dashboard.
                </p>

                <div className="flex flex-col sm:flex-row items-center gap-4">
                    <Button asChild size="lg" className="h-12 px-8 font-bold shadow-lg shadow-primary/25 rounded-xl transition-all hover:scale-105 active:scale-95">
                    ...
                    <Button asChild variant="outline" size="lg" className="h-12 px-8 font-bold border-border bg-background/50 backdrop-blur-sm rounded-xl transition-all hover:bg-muted hover:scale-105 active:scale-95">
